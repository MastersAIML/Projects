...
EMAIL_DETAILS = {
	...
	"default-header":"Your restaurant search results",
	"default-body-template":"Greetings,\nPlease find below the details of top 10 restaurants based on your search criteria.\n"
}
